...
moduleForModel('i-i-s-klinika-stomatologii-сотрудник', 'Unit | Serializer | i-i-s-klinika-stomatologii-сотрудник', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-klinika-stomatologii-сотрудник',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
