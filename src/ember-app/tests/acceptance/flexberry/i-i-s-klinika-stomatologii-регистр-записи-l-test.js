...
moduleForAcceptance('[AGAT] Acceptance | i i s klinika stomatologii регистр записи l');

test('testing i-i-s-klinika-stomatologii-регистр-записи-l', function(assert) {
