...
namespace IIS.KlinikaStomatologii
{
    ...
    public class Оплата : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.KlinikaStomatologii.ТипОплаты fТипОплаты;
        ...
        public virtual IIS.KlinikaStomatologii.ТипОплаты ТипОплаты
        {
            get
            {
                ...
                IIS.KlinikaStomatologii.ТипОплаты result = this.fТипОплаты;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ОплатаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОплатаE", typeof(IIS.KlinikaStomatologii.Оплата));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ОплатаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОплатаL", typeof(IIS.KlinikaStomatologii.Оплата));
                }
            }
        }
    }
