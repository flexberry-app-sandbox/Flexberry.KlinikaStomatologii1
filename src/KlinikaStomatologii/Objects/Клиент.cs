...
namespace IIS.KlinikaStomatologii
{
    ...
    public class Клиент : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.KlinikaStomatologii.DetailArrayOfДокументы fДокументы;
        ...
        public virtual IIS.KlinikaStomatologii.DetailArrayOfДокументы Документы
        {
            get
            {
                ...
                {
                    this.fДокументы = new IIS.KlinikaStomatologii.DetailArrayOfДокументы(this);
                }
                IIS.KlinikaStomatologii.DetailArrayOfДокументы result = this.fДокументы;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КлиентE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КлиентE", typeof(IIS.KlinikaStomatologii.Клиент));
                }
            }
            ...
            public static ICSSoft.STORMNET.View КлиентL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КлиентL", typeof(IIS.KlinikaStomatologii.Клиент));
                }
            }
        }
    }
