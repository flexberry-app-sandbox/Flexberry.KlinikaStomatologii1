...
namespace IIS.KlinikaStomatologii
{
    ...
    public class Документы : ICSSoft.STORMNET.DataObject
    {
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.KlinikaStomatologii.Клиент.
        /// </summary>
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДокументыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДокументыE", typeof(IIS.KlinikaStomatologii.Документы));
                }
            }
        }
    }
    ...
    public class DetailArrayOfДокументы : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.KlinikaStomatologii.DetailArrayOfДокументы members)

        // *** End programmer edit section *** (IIS.KlinikaStomatologii.DetailArrayOfДокументы members)
        ...
        /// </summary>
        public DetailArrayOfДокументы(IIS.KlinikaStomatologii.Клиент fКлиент) : 
                base(typeof(Документы), ((ICSSoft.STORMNET.DataObject)(fКлиент)))
        {
        }
        
        public IIS.KlinikaStomatologii.Документы this[int index]
        {
            get
            {
                return ((IIS.KlinikaStomatologii.Документы)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.KlinikaStomatologii.Документы dataobject)
        {
