...
namespace IIS.KlinikaStomatologii
{
    ...
    public class Запись : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.KlinikaStomatologii.Кабинет fКабинет;
        
        private IIS.KlinikaStomatologii.Клиент fКлиент;
        
        private IIS.KlinikaStomatologii.DetailArrayOfОказаниеУслуг fОказаниеУслуг;
        ...
        [PropertyStorage(new string[] {
                "Кабинет"})]
        [NotNull()]
        public virtual IIS.KlinikaStomatologii.Кабинет Кабинет
        {
            get
            {
                ...
                IIS.KlinikaStomatologii.Кабинет result = this.fКабинет;
        ...
        [PropertyStorage(new string[] {
                "Клиент"})]
        [NotNull()]
        public virtual IIS.KlinikaStomatologii.Клиент Клиент
        {
            get
            {
                ...
                IIS.KlinikaStomatologii.Клиент result = this.fКлиент;
        ...
        public virtual IIS.KlinikaStomatologii.DetailArrayOfОказаниеУслуг ОказаниеУслуг
        {
            get
            {
                ...
                {
                    this.fОказаниеУслуг = new IIS.KlinikaStomatologii.DetailArrayOfОказаниеУслуг(this);
                }
                IIS.KlinikaStomatologii.DetailArrayOfОказаниеУслуг result = this.fОказаниеУслуг;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЗаписьE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаписьE", typeof(IIS.KlinikaStomatologii.Запись));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЗаписьL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаписьL", typeof(IIS.KlinikaStomatologii.Запись));
                }
            }
        }
    }
