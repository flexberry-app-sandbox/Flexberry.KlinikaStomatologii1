...
namespace IIS.KlinikaStomatologii
{
    ...
    public class Сотрудник : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.KlinikaStomatologii.Должность fДолжность;
        ...
        [PropertyStorage(new string[] {
                "Должность"})]
        [NotNull()]
        public virtual IIS.KlinikaStomatologii.Должность Должность
        {
            get
            {
                ...
                IIS.KlinikaStomatologii.Должность result = this.fДолжность;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СотрудникE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникE", typeof(IIS.KlinikaStomatologii.Сотрудник));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СотрудникL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникL", typeof(IIS.KlinikaStomatologii.Сотрудник));
                }
            }
        }
    }
