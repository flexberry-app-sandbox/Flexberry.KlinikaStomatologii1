...
namespace IIS.KlinikaStomatologii
{
    ...
    public class Материал : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.KlinikaStomatologii.Производитель fПроизводитель;
        ...
        [PropertyStorage(new string[] {
                "Производитель"})]
        [NotNull()]
        public virtual IIS.KlinikaStomatologii.Производитель Производитель
        {
            get
            {
                ...
                IIS.KlinikaStomatologii.Производитель result = this.fПроизводитель;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View МатериалE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("МатериалE", typeof(IIS.KlinikaStomatologii.Материал));
                }
            }
            ...
            public static ICSSoft.STORMNET.View МатериалL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("МатериалL", typeof(IIS.KlinikaStomatologii.Материал));
                }
            }
        }
    }
