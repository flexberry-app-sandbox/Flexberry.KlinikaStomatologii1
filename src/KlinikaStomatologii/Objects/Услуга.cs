...
namespace IIS.KlinikaStomatologii
{
    ...
    public class Услуга : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.KlinikaStomatologii.DetailArrayOfСоставУслуги fСоставУслуги;
        ...
        public virtual IIS.KlinikaStomatologii.DetailArrayOfСоставУслуги СоставУслуги
        {
            get
            {
                ...
                {
                    this.fСоставУслуги = new IIS.KlinikaStomatologii.DetailArrayOfСоставУслуги(this);
                }
                IIS.KlinikaStomatologii.DetailArrayOfСоставУслуги result = this.fСоставУслуги;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View УслугаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("УслугаE", typeof(IIS.KlinikaStomatologii.Услуга));
                }
            }
            ...
            public static ICSSoft.STORMNET.View УслугаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("УслугаL", typeof(IIS.KlinikaStomatologii.Услуга));
                }
            }
        }
    }
